...
import { buyFailure, buySuccess, doBuy, doSell, sellFailure, sellSuccess, setCurrencyPair, updateWallet } from '../../shared/actions'
...
console.log({ ACCOUNT_KEY, ACCOUNT_SECRET })
