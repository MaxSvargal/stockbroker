...
export type ClearRVIResultsPayload = { symbol: string }
export type SetTradeSignalPayload = { symbol: string, name: 'macd' | 'rvi' }
export type PosisionPayload = { symbol: SYMBOL, id: ID, mts: MTS, cid: CID, price: PRICE, amount: AMOUNT, isSell: boolean, covered?: number[], profit?: number }
